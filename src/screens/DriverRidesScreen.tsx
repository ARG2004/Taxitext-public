...
import { ArrowLeft, MapPin, Calendar, CreditCard, User } from 'lucide-react-native';
...
export default function DriverRidesScreen({ navigation }: any) {
  ...
  useEffect(() => {
    ...
    const unsub = firestore()
      ...
      .onSnapshot(
        ...
        (error) => {
          console.log('Error al consultar historial de servicios de conductor:', error);
          setLoading(false);
        }
      );
    ...
    <SafeAreaView style={styles.safe}>
      ...
      {loading ? (
        ...
        <View style={styles.center}>
          ...
          <Text style={styles.emptyTitle}>Sin servicios realizados</Text>
          <Text style={styles.emptySub}>
            Las solicitudes de viaje que aceptes y completes se mostrarán aquí.
          </Text>
        </View>
      ) : (
        <FlatList
...
const styles = StyleSheet.create({
  ...
  passengerText: { fontSize: 13, color: Colors.textSecondary, fontWeight: '600' },
